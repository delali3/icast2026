...
<head>
  ...
  <meta name="keywords" content="IEEE, ICAST 2026, Ghana, ICAST Ghana Conference 2026, International Conference, Advanced Science and Technology, IEEE Ghana Section, research, innovations, Academic City University, ICAST GH 2026">
  <meta name="description" content="Join the IEEE ICAST 2026 in Ghana, the premier International Conference on Advanced Science and Technology. Hosted by the IEEE Ghana Section, this event brings together global researchers and innovators at the Academic City University to explore the latest advancements in science and technology. Don't miss out on this pivotal conference for groundbreaking research and innovations in Ghana.">

  <title>IEEE ICAST 2026 - Ghana | International Conference on Advanced Science and Technology</title>
  <!-- Favicons -->
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <h1><a href="#main">I<span>CAST</span>2026</a></h1>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0"><span>ICAST </span>2026</h1>
      <p class="mb-4 pb-0">24 – 26 October 2026, Academic City University</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>IEEE ICAST 2026 is accepting submission for the 9th ICAST. This is sponsored by the IEEE Ghana Section
            </p>
          </div>
          <div class="col-lg-3">
            <h3>Where</h3>
            <p>Academic City University</p>
          </div>
          <div class="col-lg-3">
            <h3>When</h3>
            <p>Monday to Wednesday<br>24-26 October 2026</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="container mt-5 mb-5">
          <div class="row justify-content-center">
            <div class="col-lg-10">
              <div class="card">
                <h5 class="card-title text-muted text-uppercase text-center">IEEE ICAST 2026 Registration Form</h5>
                <hr>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@ieeeghicast2026.org">info@ieeeghicast2026.org</a></p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>
              IEEE ICAST 2026 is accepting submission for the IEEE Ghana section.
              <br>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              Academic City University <br>
              Accra<br>
              Ghana <br>
              <strong>Phone:</strong> +233 20 835 1347 <br> +233 24 965 3242 <br>
              <strong>Email:</strong> info@ieeeghicast2026.org<br>
            </p>
